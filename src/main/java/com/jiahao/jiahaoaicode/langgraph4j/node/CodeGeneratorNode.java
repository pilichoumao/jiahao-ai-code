...
import com.jiahao.jiahaoaicode.langgraph4j.model.QualityResult;
...
//            String userMessage = context.getEnhancedPrompt();
            ...
            Long appId = 0L;
            // 调用流式代码生成
            Flux<String> codeStream = codeGeneratorFacade.generatorAndSaveCodeStream(userMessage, generationType, appId);
            // 同步等待流式输出完成
